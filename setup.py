...
if __name__ == '__main__':
    setup(
        ...
        extras_require={
            ...
            'deepspeed': parse_requirements('requirements/runtime.txt') + parse_requirements('requirements/deepspeed.txt'),
            'modelscope': parse_requirements('requirements/runtime.txt') + parse_requirements('requirements/modelscope.txt'),
        },
        zip_safe=False,
